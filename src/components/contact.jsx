            ...
            <div className="main">
                ...
                <div className='end_side' ref={el => other = el}>
                    ...
                    <div className='end_links'>
                        ...
                        <div className='end_links_tab'>
                            <div style={{cursor: "pointer"}} onClick={() => routerLink("/magazine")}>Magazine</div>
                            <div style={{cursor: "pointer"}} onClick={() => routerLink("/podcasts")}>Podcast</div>
                            <div style={{cursor: "pointer"}} onClick={() => routerLink("/authors")}>Authors</div>
                        </div>
                        <div className='end_links_tab'>
                            <div>Styleguide</div>
                            <div>Licensing</div>
