...
function App() {
  ...
  const routerLink = (path) => {
    if (location.pathname !== path) {
      gsap.to(containerMain, { opacity: 0, duration: 0.6 });
      gsap.to(loader2, {
        translateY: "0%",
        duration: 1.4,
        ease: "expo",
      ...
      setTimeout(() => {
        navigate(path);
        window.scrollTo(0, 0);
        gsap.to(containerMain, { opacity: 1, duration: 0.6, delay: 0.2 });
        gsap.to(loader2, {
          translateY: "100%",
          duration: 1.4,
          ease: "expo",
