        ...
        <div data-scroll-section>
            <div>
                ...
                <div className='magazine' ref={el => mag = el}>
                    ...
                    {filterArt ? <Art array={pods.filter((x) => x.type === "ART")} />  : null}
                    {filterSculpture ? <Art array={pods.filter((x) => x.type === "SCULPTURES")} />  : null}
                    {filterStreetArt ? <Art array={pods.filter((x) => x.type === "STREET ART")} />  : null}
                </div>
            </div>
        </div>
     );
